...
Please do not hesitate let us know at at any time if you want to be shown something 
specific within our app's reactive features during our demonstration soon.

```{r}
stella <- image_read("stella.jpg")
stella
```
