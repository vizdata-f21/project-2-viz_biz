...
p <- plot_triangles(c(6:3), skip_color = new_color)
p <- plot_semicircles(c(3:1), skip_color = new_color)
p <- plot_semicircle_stroke_color(c(1), skip_color = new_color)
p <- plot_semicircle_stroke(c(1), skip_color = new_color)
p <- plot_quads(c(4:1), skip_color = new_color)
p <- plot_circles(c(6:2), skip_color = new_color)
p <- plot_triangles(c(2:1), skip_color = new_color)
p <- plot_circles(c(1), skip_color = new_color)
p <- plot_lines(c(2:1))
